...
export const HomeIntroduction = () => {
  ...
  return (
    <View className="mx-6 mt-14">
      <TextWrapper className="text-3xl color-customBlue text-center font-IBM_bold" >Welcome to HabitDesk!</TextWrapper>
     ...
     <TextWrapper className="text-white text-xl font-IBM_semibold">Get Started</TextWrapper>
    </HomeButton>
    </View>
  )
}
