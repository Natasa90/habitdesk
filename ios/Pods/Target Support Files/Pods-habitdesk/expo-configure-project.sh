...
with_node \
  ...
  --target "/Users/natasa/Desktop/habitdesk/ios/Pods/Target Support Files/Pods-habitdesk/ExpoModulesProvider.swift" \
  --entitlement "/Users/natasa/Desktop/habitdesk/ios/habitdesk/habitdesk.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-web-browser"
